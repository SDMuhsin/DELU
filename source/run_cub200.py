...
def get_model(model_name):
    ...
    # Modify the last layer for CUB-200 (200 classes)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CUB-200 CNN Training')
    parser.add_argument('--model', type=str, default='resnet18', choices=['resnet18', 'vgg16', 'densenet121'],
                        help='model architecture')
    parser.add_argument('--data-dir', type=str, default='./data/CUB_200_2011', help='data directory')
