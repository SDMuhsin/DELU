...
def load_data(data_dir, batch_size):
    ...
    train_dataset = datasets.GTSRB(data_dir, split='train', download=True, transform=transform)
    test_dataset = datasets.GTSRB(data_dir, split='test', download=True, transform=transform)
...
def get_model(model_name):
    ...
    # Modify the last layer for GTSRB (43 classes)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GTSRB CNN Training')
    ...
    parser.add_argument('--activation', type=str, default='ReLU',choices=['ADELU','ReLU', 'LeakyReLU', 'ELU', 'SELU', 'GELU', 'Tanh', 'Sigmoid','Hardswish', 'Mish', 'SiLU', 'Softplus', 'Softsign', 'Hardshrink','Softshrink', 'Tanhshrink', 'PReLU', 'RReLU', 'CELU', 'Hardtanh','DELU'],help='Activation function to use in the model')
